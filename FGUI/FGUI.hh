...
#define ADD_COLORLIST(element, x, y, name, width, height, identificator, font, \
                      parent, page)                                            \
  {                                                                            \
...
#define ADD_COLORPICKER(element, x, y, color, identificator, font, parent,     \
                        page)                                                  \
  {                                                                            \
...
#define ADD_GROUPBOX(element, x, y, name, width, height, font, parent, page,   \
                     scrollable, resizeable, hideable)                         \
  {                                                                            \
...
#define ADD_KEYBINDER(element, x, y, name, key, identificator, font, parent,   \
                      page)                                                    \
  {                                                                            \
...
#define ADD_LISTBOX(element, x, y, name, width, height, identificator, font,   \
                    parent, page)                                              \
  {                                                                            \
...
#define ADD_SLIDER(element, x, y, name, value, min, max, identificator, font,  \
                   parent, page)                                               \
  {                                                                            \
...
#define ADD_SPINNER(element, x, y, name, value, min, max, identificator, font, \
                    parent, page)                                              \
  {                                                                            \
...
#define ADD_TEXTBOX(element, x, y, name, text, max_length, flag,               \
                    identificator, font, parent, page)                         \
  {                                                                            \
...
#define ADD_CONTROLLER(element, controller) element->set_controller(controller);

#define ADD_TOOLTIP(element, tooltip) element->set_tooltip(tooltip);

// button, comboboxes and containers
#define ADD_FUNCTION(element, function) element->set_function(function);
