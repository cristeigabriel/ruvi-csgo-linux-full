...
public:
	...
	bool get_player_info( int ent_num, player_info_t* p_info ) {
		return memory::vfunc<8, bool>( this, ent_num, p_info );
	}
	...
	void get_view_angles( vector* v_angles ) {
		return memory::vfunc<18, void>( this, v_angles );
	}

	void set_view_angles( vector* v_angles ) {
		return memory::vfunc<19, void>( this, v_angles );
	}
	...
	char const* get_map_name( ) {
		return memory::vfunc<52, char const*>( this );
	}
