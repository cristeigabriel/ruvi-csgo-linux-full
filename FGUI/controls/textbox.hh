...
// iinput system
constexpr std::string_view m_iinput_system_text[] = {
...
public:
  ...
  inline fgui::state get_state() const noexcept { return m_is_getting_key; }
  ...
  inline bool get_text_flag(const fgui::text_flags &flags) const noexcept {
    ...
    if (m_text_flag & static_cast<int>(flags)) return true;
  ...
  inline std::string get_text() const noexcept { return m_text; }
