...
public:
  ...
  void add_control(const std::shared_ptr<fgui::element> &control,
                   int page_index = -1, bool manual_size = false);
  ...
  // get the amount that a element is suposed to move according with the
  // scrollbar
  inline int get_scroll_offset() const noexcept { return m_scroll_offset; }
