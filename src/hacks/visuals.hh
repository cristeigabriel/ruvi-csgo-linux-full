...
protected:
  ...
  void player_advanced(entity_t *entity); // player advanced drawing (chams, custom textures, glow, etc)
  void world_advanced(entity_t* entity); // non player advanced drawing (weapon chams, weapon, glow, custom weapon skins, etc)
private:
  ...
  void player_chams(entity_t* entity);
private:
