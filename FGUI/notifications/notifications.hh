...
struct notification_info {
  ...
  notification_info(const std::string_view      _text,
                    const fgui::animation_type &_animation_type)
      : text(_text), animation_type(_animation_type), animation_progress(0.f),
        state(true), tick(0) {}
...
public:
  ...
  inline void
  add_notification(const std::string_view      _text,
                   const fgui::animation_type &_animation_type) noexcept {
