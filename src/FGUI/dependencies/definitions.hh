...
// you are not supposed to edit the contents of this namespace. but if you know
// what you are doing, go ahead.
namespace detail {
...
struct item_info {
  ...
  item_info(const std::string_view _item, int _value)
...
// everything inside this namespace usually depends of an external library to
// work.
namespace external {
...
enum struct animation_type : int { LINEAR = 1, FADE };
...
typedef struct point_2d {
  ...
  point_2d operator/(const int &rhs) { return point_2d(x / rhs, y / rhs); }
...
typedef struct vertex_2d {
  ...
  vertex_2d() = default;
  vertex_2d(const fgui::precision_point &_position,
            const fgui::precision_point &_text_coord = {0.f, 0.f})
      : position(_position), text_coord(_text_coord) {}
