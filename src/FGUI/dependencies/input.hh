...
// you are not suposed to edit the contents of this namespace, unless you know
// what you are doing.
namespace detail {
...
inline void listen() {
  ...
  std::copy(fgui::detail::m_key_state.begin(), fgui::detail::m_key_state.end(),
            fgui::detail::m_old_key_state.begin());
  ...
  fgui::detail::m_mouse_position_delta = {
      (fgui::detail::m_mouse_position.x - last_known_position.x),
      (fgui::detail::m_mouse_position.y - last_known_position.y)};
...
inline const fgui::state key_press(const fgui::key &key) noexcept {
  ...
  return (fgui::detail::m_key_state[key] &&
          !fgui::detail::m_old_key_state[key]);
}
...
inline const fgui::state mouse_in_area(const fgui::rect &area) noexcept {
  return (fgui::detail::m_mouse_position.x > area.left &&
          fgui::detail::m_mouse_position.y > area.top &&
          fgui::detail::m_mouse_position.x < area.left + area.right &&
          fgui::detail::m_mouse_position.y < area.top + area.bottom);
}

inline const fgui::state mouse_in_area(const int &x, const int &y, const int &w,
                                       const int &h) noexcept {
  return (fgui::detail::m_mouse_position.x > x &&
          fgui::detail::m_mouse_position.y > y &&
          fgui::detail::m_mouse_position.x < x + w &&
          fgui::detail::m_mouse_position.y < y + h);
}
