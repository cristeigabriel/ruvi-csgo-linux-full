...
struct color_info {
  color_info(const std::string_view _identificator, const fgui::color &_color,
...
public:
  ...
  inline void add_color(const std::string_view identificator,
                        const fgui::color &    color,
                        bool gradient_state = false) noexcept {
  ...
  inline void set_color(const int &index, const fgui::color &color,
                        bool gradient_state = false) noexcept {
